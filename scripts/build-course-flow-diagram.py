...
COURSES = {
    ...
    "ai-assisted-testing-path": {
        "title": "The AI-Assisted Testing Learning Path",
        "sub": "The order the AI-Assisted Software Testing course is taught at Archer Infotech, Pune",
        "stages": [
            ("GenAI Foundations", "LLMs, tokens, context, hallucination", (56, 189, 248)),
            ("Prompting for QA", "Constraints, schemas, reusable templates", (129, 140, 248)),
            ("Requirement Analysis", "Ambiguity, contradictions, acceptance criteria", (168, 85, 247)),
            ("Test Design", "Scenarios, boundary, negative, risk-based", (45, 212, 191)),
            ("Test Data", "Synthetic data, masking, PII rules", (52, 211, 153)),
            ("Automation & Triage", "Generated tests, stack traces, flaky tests", (250, 204, 21)),
            ("Docs & Responsible Use", "Test plans, prompt library, secrets, policy", (251, 146, 60)),
        ],
        "tail": "PROMPT | REVIEW | APPROVE",
    },
    "llm-rag-testing-path": {
        "title": "The LLM & RAG Testing Learning Path",
        "sub": "The order the Generative AI, LLM & RAG Testing course is taught at Archer Infotech, Pune",
        "stages": [
            ("AI Architecture", "Prompts, tokens, context, non-determinism", (56, 189, 248)),
            ("Quality Dimensions", "Correctness, groundedness, safety, refusal", (129, 140, 248)),
            ("LLM Test Design", "Prompt variation, multi-turn, adversarial", (168, 85, 247)),
            ("Hallucination & Grounding", "Fabricated facts, citation validation", (45, 212, 191)),
            ("Evaluation Datasets", "Golden datasets, rubrics, baselines", (52, 211, 153)),
            ("Evaluation Methods", "Deterministic, similarity, LLM-as-a-Judge", (250, 204, 21)),
            ("Python Automation", "pytest, retries, token cost, baselines", (251, 146, 60)),
            ("RAG, Safety & Capstone", "Retrieval metrics, injection, CI gates", (248, 113, 113)),
        ],
        "tail": "EVALUATE, DO NOT ASSERT",
    },
    "agentic-ai-testing-path": {
        "title": "The Agentic AI Testing Learning Path",
        "sub": "The order the Agentic AI Testing course is taught at Archer Infotech, Pune",
        "stages": [
            ("Agent Architecture", "Plan-act-observe, tools, state, memory", (56, 189, 248)),
            ("Test Strategy", "Assert vs evaluate, golden tasks, mocks", (129, 140, 248)),
            ("Tool-Call Testing", "Wrong tool, bad arguments, retries", (168, 85, 247)),
            ("Trajectory Evaluation", "Critical steps, loops, recovery", (45, 212, 191)),
            ("Memory & Multi-Agent", "Stale memory, leakage, handoffs", (52, 211, 153)),
            ("Agent Security", "Indirect injection, excessive agency", (250, 204, 21)),
            ("Metrics & Offline Eval", "Task success, cost per task, gates", (251, 146, 60)),
            ("Production & Capstone", "Tracing, drift, review queues, CI harness", (248, 113, 113)),
        ],
        "tail": "JUDGE THE PATH, NOT ONLY THE ANSWER",
    },
    "vibe-coding-path": {
    ...
    "oracle-database-path": {
        ...
        "stages": [
            ("Database Foundations", "DBMS types, relational model, keys", (56, 189, 248)),
            ("Oracle & Setup", "Editions, install, SQL Developer, listener", (129, 140, 248)),
            ("Architecture", "SGA, PGA, background processes, storage", (168, 85, 247)),
            ("Storage & Redo", "Tablespaces, control files, redo, archiving", (45, 212, 191)),
            ("Users & Schemas", "Users, profiles, quotas, passwords", (52, 211, 153)),
            ("Core SQL", "DDL, DML, data types, constraints, SELECT", (250, 204, 21)),
            ("Functions & Joins", "Built-ins, aggregates, subqueries, sets", (251, 146, 60)),
            ("Objects & Normalization", "Views, sequences, indexes, 1NF to BCNF", (248, 113, 113)),
            ("PL/SQL", "Blocks, cursors, exceptions, procedures", (56, 189, 248)),
            ("Packages & Advanced", "Packages, triggers, BULK COLLECT, FORALL", (129, 140, 248)),
            ("Administration", "Security, startup, Oracle Net, undo, RMAN", (168, 85, 247)),
            ("Tuning & Capstone", "Optimizer, partitioning, multitenant, project", (45, 212, 191)),
        ],
    },
    "firebase-path": {

...
export const listicles: Listicle[] = [
  ...
  // 11 ─ Spring Boot projects (Java pillar spoke, 2026-06-07) ───────────────
  {
    ...
    entries: [
      ...
      { name: "Microservices with Spring Cloud", what: "3-service microservice architecture: API Gateway + Service Discovery (Eureka) + 2 business services + inter-service REST calls.", dataPoint: "Demonstrates senior-fresher architectural thinking; pays ₹2-4 LPA above standard backend band.", bestFor: "Targeting Pune product companies + above-band services roles.", href: "/courses/programming/spring-boot-microservices-training-in-pune" },

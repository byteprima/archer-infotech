...
export const dataScienceTrainingInPune: CourseRichContent = {
  ...
  curriculum: [
    {
      ...
      topics: [
          ...
          "Shape, Dimensions, Size and Data Types",
          "Importing CSV, Excel, JSON, SQL and Text",
          "Missing Data",
    ...
    },
    {
      ...
      topics: [
          ...
          "Transpose, Determinant, Inverse and Rank",
          "Bayes' Theorem",
    ...
    },
    {
      ...
      weekRange: "Week 5",
      description:
        "The stage that moves a model more than swapping algorithms does. You work through encoding (one-hot, ordinal, target, frequency) and when each leaks information; scaling and transformation, including why tree models do not care and distance-based models do; and constructing features from dates, text, aggregations and domain knowledge. Then selection — filter, wrapper and embedded methods, multicollinearity, and the discipline of removing features that only look useful. Data leakage is treated as a first-class topic here, because it is the single most common reason a model that scored 0.95 in a notebook fails in production.",
      topics: [
        "One-hot, ordinal, target and frequency encoding",
        "Scaling, normalisation and power transforms",
        "Date, text and aggregation features",
    ...
    },
    {
      ...
      weekRange: "Week 8",
      description:
        "Time-series breaks the assumptions every other model in the course relies on, so it gets its own module. Decomposition into trend, seasonality and residual; stationarity and why it matters; ACF and PACF for order selection; then the model families in order of pragmatism — naive and seasonal baselines that are surprisingly hard to beat, exponential smoothing, ARIMA and SARIMA, and Prophet. Validation is the part most courses get wrong: you use forward-chaining splits, never random ones, because a random split lets the model see the future.",
      topics: [
        "Trend, seasonality and residual decomposition",
        "Stationarity, differencing and ADF testing",
        "ACF and PACF interpretation",
        "Naive and seasonal baselines",
        "Exponential smoothing and Holt-Winters",
        "ARIMA and SARIMA",
        "Prophet for business forecasting",
        "Forward-chaining validation for temporal data",
      ],
    },
    {
      title: "Explainability, Anomaly Detection & Recommenders",
      weekRange: "Week 8",
      description:
        "Three applied areas that come up constantly in Indian analytics and product teams. Explainability first, because a model nobody can interrogate does not get deployed in finance, insurance or healthcare: feature importance, permutation importance, SHAP and LIME, partial dependence, and how to answer 'why was this application rejected?'. Then anomaly detection for fraud, quality and monitoring — statistical methods, Isolation Forest, one-class SVM and autoencoders. Finally recommender systems: collaborative filtering, content-based approaches, matrix factorisation, and the cold-start problem every real deployment hits.",
      topics: [
        ...
        "Matrix factorisation and cold start",
      ],
    },
    {
      ...
      topics: [
          ...
          "Cloud Model Training and Deployment",
          "MLflow",
          "Pickle and Joblib",
          "Docker Compose",
  ...
  roadmapImage: {
    src: "/images/courses/data-science-workflow-v1.webp",
    width: 1400,
    height: 736,
    alt: "Diagram of the Data Science workflow taught at Archer Infotech Pune: framing the problem, exploration with EDA and statistics, feature engineering, modelling with regression, classification and ensembles, evaluation and explainability, then deployment and communicating findings.",
    caption:
      "The six stages of the Data Science workflow this course follows — every stage is covered module by module below.",
  },


  syllabusDownload: {
    pdfUrl: "/downloads/data-science-syllabus-v1.pdf",
    title: "Data Science Course Syllabus — Complete Module List",
    slug: "data-science-syllabus",
    blurb:
      "The full thirty-six-module syllabus as a 9-page PDF — Python, NumPy and Pandas, the mathematics and statistics underneath the models, EDA, feature engineering, the machine-learning algorithm families, model validation, time-series, NLP and the capstone. Everything in it is on this page; the PDF is the portable version.",
    asideBlocks: [
      {
        heading: "What is inside the 9-page PDF",
        items: [
          "All thirty-six modules in teaching order, from data-science fundamentals through to model deployment and interview preparation.",
          "The mathematics and statistics modules stated explicitly — linear algebra, calculus, probability, distributions, hypothesis testing and inference — so you can see exactly what is assumed and what is taught.",
          "The full modelling sequence: regression, classification, ensembles, unsupervised learning, dimensionality reduction, validation and ML pipelines.",
        ],
      },
      {
        heading: "Roles this syllabus prepares you for",
        items: [
          "Data Scientist — experimentation, modelling and communicating findings to a business.",
          "Applied Data Scientist — production-facing modelling work at product companies.",
          "Analytics Consultant — framing business problems as data problems.",
          "Junior Data Scientist — the realistic fresher entry point with a strong project portfolio.",
        ],
      },
    ],
  },

...
export const machineLearningTrainingInPune: CourseRichContent = {
  ...
  curriculum: [
    {
      ...
      topics: [
          ...
          "Data Quality",
          "Nominal, Ordinal, Binary and High-Cardinality Variables",
          "Min-Max Scaling",
          "Train-Test Split",
          "Missing Values",
          "Label Encoding",
    ...
    },
    {
      ...
      topics: [
          ...
          "Instance-Based and Lazy Learning",
          "Bayes' Theorem",
    ...
    {
      title: "Imbalanced Learning & Cost-Sensitive ML",
      weekRange: "Week 5",
      description:
        "Fraud, churn, defaults, defect detection — the problems businesses actually pay for are almost all imbalanced, and accuracy is a useless metric on all of them. You work through resampling (SMOTE and its variants, undersampling, and why naive oversampling before the split leaks), class weighting, and threshold optimisation driven by the cost of each error type rather than a default 0.5. Evaluation shifts to precision-recall curves, PR AUC and calibration. The framing throughout is business cost: a false negative and a false positive rarely cost the same, and the model should reflect that.",
      topics: [
        "Why accuracy fails on imbalanced data",
        "SMOTE, ADASYN and undersampling",
        "Resampling inside the CV fold, not before",
        "Class weights and cost matrices",
        "Threshold optimisation by expected cost",
        "Precision-recall curves and PR AUC",
        "Probability calibration — Platt and isotonic",
        "Cost-sensitive evaluation",
      ],
    },
    {
      title: "Clustering & Dimensionality Reduction in Depth",
      weekRange: "Week 5",
      description:
        "Unsupervised work is where practitioners most often produce confident nonsense, because there is no test-set score to catch them. K-Means with the elbow and silhouette methods and its assumptions about cluster shape; hierarchical clustering and dendrogram reading; DBSCAN for arbitrary shapes and noise; Gaussian mixtures for soft assignment. Then dimensionality reduction — PCA and what the components actually mean, t-SNE and UMAP for visualisation, and the standing warning that both will happily produce beautiful, meaningless structure if you tune them until it appears.",
      topics: [
        "K-Means, elbow method and silhouette score",
        "Cluster shape assumptions and failure modes",
        "Hierarchical clustering and dendrograms",
        "DBSCAN for arbitrary shapes and noise",
        "Gaussian mixture models and soft assignment",
        "PCA and interpreting components",
        "t-SNE and UMAP for visualisation",
        "Validating an unsupervised result",
      ],
    },
    {
      ...
      weekRange: "Week 6",
      description:
        "Ensembles win most tabular problems, and most competitions, so they get treated properly rather than as a footnote on decision trees. Bagging and why averaging decorrelated trees reduces variance; Random Forest and its out-of-bag estimate; then boosting as a fundamentally different idea — fitting sequentially to the residual. XGBoost, LightGBM and CatBoost are covered as distinct tools with different strengths (sparse data, leaf-wise growth, native categorical handling) rather than interchangeable names, along with the hyperparameters that actually move the needle and the ones that do not.",
      topics: [
        "Bagging and variance reduction",
        "Random Forest and out-of-bag error",
        "Boosting — fitting to the residual",
        "XGBoost: regularisation and sparsity handling",
        "LightGBM: leaf-wise growth and speed",
  ...
  roadmapImage: {
    src: "/images/courses/machine-learning-workflow-v1.webp",
    width: 1400,
    height: 736,
    alt: "Diagram of the Machine Learning lifecycle taught at Archer Infotech Pune: data collection and splitting, feature engineering, algorithm selection across regression, trees, SVM and boosting, training with cross-validation and tuning, evaluation and error analysis, then deployment and monitoring for drift.",
    caption:
      "The six stages of the Machine Learning lifecycle this course follows — every stage is covered module by module below.",
  },


  syllabusDownload: {
    pdfUrl: "/downloads/machine-learning-syllabus-v1.pdf",
    title: "Machine Learning Course Syllabus — Complete Module List",
    slug: "machine-learning-syllabus",
    blurb:
    ...
    asideBlocks: [
      ...
      },
      {
        ...
        items: [
          "Machine Learning Engineer — building, evaluating and deploying models in production.",
          "AI/ML Engineer — the applied-modelling path into deep learning and generative AI.",
          "Data Scientist — the modelling half of the role, in depth.",
          "Applied ML Engineer — productionising models at Pune product companies.",
        ],
      },
    ],
  },

...
export const dataAnalyticsTrainingInPune: CourseRichContent = {
  ...
  curriculum: [
    {
      title: "Data Analytics Foundations & the Analytics Lifecycle",
      weekRange: "Week 1",
      description:
        "Before any tool, the shape of the job. What a Data Analyst actually does day to day, and how the role differs from a Data Scientist, a Business Analyst and a BI Developer — a distinction most candidates get wrong in interviews. Then the four analytics types (descriptive, diagnostic, predictive, prescriptive) and the lifecycle every piece of analysis follows: business problem, collection, cleaning, transformation, EDA, visualisation, insight, reporting, decision. You finish the week able to take a vague business question and say what data you would need and what the output should look like — which is the skill the rest of the course builds on.",
      topics: [
        "Data Analyst vs Data Scientist vs BI Developer",
        "Descriptive, diagnostic, predictive, prescriptive analytics",
        "The analytics lifecycle end to end",
    ...
    },
    {
      ...
      topics: [
          ...
          "Connecting to Excel, CSV, Text, Folder, Web and Databases",
    ...
    },
    {
      ...
      topics: [
          ...
          "Database, DBMS, RDBMS, Schema, Tables, Keys and Relationships",
          "CREATE, INSERT, UPDATE, DELETE, SELECT",
          "DISTINCT, Aliases, LIMIT/TOP",
    ...
    {
      title: "Power Query — Repeatable Data Preparation",
      weekRange: "Week 4",
      description:
        "The part of Excel that separates an analyst from a spreadsheet user. Power Query turns the manual clean-up you would otherwise repeat every month into a refreshable pipeline: connect to a source, apply a sequence of transformation steps, and re-run it against next month's file with one click. You learn the transformation set that covers most real work — splitting and merging columns, unpivoting the cross-tab exports finance teams send, type handling, appends and merges across files — and, importantly, why doing this in Power Query rather than by hand is what makes a report auditable.",
      topics: [
        "Connecting to files, folders and databases",
        "Applied steps and the query editor",
        "Split, merge and extract columns",
        "Unpivot cross-tab exports",
        "Data type handling and locale issues",
        "Append and merge queries",
        "Grouping and aggregation",
        "Refreshable, auditable transformations",
      ],
    },
    {
      ...
      topics: [
          ...
          "Python Installation, Jupyter Notebook and Google Colab",
          "NumPy Arrays",
          "Series and DataFrame",
          "Data Quality Dimensions",
          "Variables, Data Types and Operators",
          "Shape, Dimensions and Data Types",
          "Importing CSV, Excel, JSON and SQL Data",
          "Missing Data",
          "Lists, Tuples, Sets and Dictionaries",
          "Indexing, Slicing, Filtering and Reshaping",
        ],
    },
    {
    ...
    {
      title: "Business Analytics, KPIs & Executive Reporting",
      weekRange: "Week 9",
      description:
        "Analysis that changes a decision, rather than analysis that produces a chart. This module works through the domains Pune employers actually hire analysts into — sales, marketing, finance, HR, operations and inventory — and what each one measures. You learn to define a KPI properly (metric, target, owner, cadence), to build a KPI tree that connects an operational number to a business outcome, and to write the executive summary that sits above a dashboard. The recurring failure this addresses: analysts who can build the report but cannot say what it means.",
      topics: [
        "Sales, marketing and financial analytics",
        "HR and operational analytics",
        "Inventory and supply analysis",
        "Defining a KPI: metric, target, owner, cadence",
        "KPI trees and driver analysis",
        "Revenue and profitability tracking",
        "Executive summaries and reporting cadence",
        "Cohort and retention basics",
      ],
    },
    {
      title: "Git, GitHub & the Analyst Portfolio",
      weekRange: "Week 10",
      description:
        "Version control is not just a developer concern — it is how you prove the work is yours and how a hiring manager sees it before they meet you. You learn the practical Git subset an analyst needs (repositories, commits, branches, pull requests) and then build the portfolio itself: notebooks that read top to bottom, a README that states the business question and the answer, dashboards published where a recruiter can open them. Every project from the course ends up here, which is what turns a completed course into something you can send a link to.",
      topics: [
        "Repositories, commits and history",
        "Branching and pull requests",
        "Writing a README that states the question and answer",
        "Structuring a notebook for a reader",
        "Publishing dashboards for a recruiter",
    ...
    },
    {
      ...
      topics: [
          ...
          "Repository, Clone, Add, Commit, Push and Pull",
          "Excel",
          "GitHub Repositories",
          "SQL",
          "README Files",
  ...
  roadmapImage: {
    src: "/images/courses/data-analytics-workflow-v1.webp",
    width: 1400,
    height: 654,
    alt: "Diagram of the Data Analytics workflow taught at Archer Infotech Pune: raw data from Excel, SQL, CSV and APIs, then cleaning and preparation, then analysis with Pandas, SQL and statistics, then visualisation in Power BI, ending in KPIs, dashboards and business decisions.",
    caption:
      "The five stages of the Data Analytics workflow this course follows — every stage is covered module by module below.",
  },


  syllabusDownload: {
    pdfUrl: "/downloads/data-analytics-syllabus-v1.pdf",
    title: "Data Analytics Course Syllabus — Complete Module List",
    slug: "data-analytics-syllabus",
    blurb:
      "The full twenty-module syllabus this course follows, as a 7-page PDF you can keep or share — Excel and Power Query, SQL, statistics, Python, NumPy, Pandas, EDA, visualisation, Power BI, business analytics, KPIs, data storytelling and the capstone. Everything in it is on this page; the PDF is the portable version.",
    asideBlocks: [
      {
        heading: "What is inside the 7-page PDF",
        items: [
          "All twenty modules in teaching order, from data-analytics fundamentals and the analytics lifecycle through to interview preparation.",
          "Every sub-section listed topic by topic — Excel functions, Power Query transformations, SQL joins and window functions, statistics, Pandas operations, EDA techniques and Power BI/DAX.",
          "The project and capstone progression, plus the AI-assisted analytics and Git/GitHub modules that sit alongside the core track.",
        ],
      },
      {
        heading: "Roles this syllabus prepares you for",
        items: [
          "Data Analyst — reporting, dashboards and business insight at Pune services majors and GCC captives.",
          "Business Analyst — translating business questions into data questions and back again.",
          "BI Analyst or BI Developer — Power BI semantic models, DAX measures and executive reporting.",
          "MIS and Reporting Analyst — recurring operational reporting built on SQL and Excel.",
        ],
      },
    ],
  },

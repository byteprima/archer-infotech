...
export const seleniumTrainingInPune: CourseRichContent = {
  ...
  curriculum: [
    ...
    {
      title: "Core Java for Test Automation",
      weekRange: "Weeks 1–2",
      description:
      ...
      topics: [
        "Java fundamentals and the JDK setup",
    ...
    },
    {
      ...
      topics: [
        ...
        "WebDriver setup and driver management",
        "Browser automation",
    ...
    },
    {
      ...
      topics: [
        ...
        "Test dependencies",
        "Parallel execution and driver thread safety",
        "TestNG XML",
        "Test suites",
      ],
    },
    {
      title: "Maven and Dependency Management",
      weekRange: "Week 5",
      description:
      ...
      topics: [
        ...
        "pom.xml anatomy",
        "Dependencies, versions and scopes",
        "Transitive dependencies and conflict resolution",
        "Plugins — Surefire and compiler",
        "Build lifecycle",
    ...
    },
    {
      ...
      topics: [
        "Introduction to BDD and the three-amigos practice",
        "Gherkin syntax",
        "Feature files",
        "Scenarios",
        "Scenario outlines",
        ...
        "Cucumber with Selenium and the Page Object layer",
        "Cucumber reports",
      ],
    },
    {
      ...
      topics: [
        ...
        "Attaching logs and environment metadata",
        "Test execution reports for different audiences",
      ],
    },
    {
      ...
      topics: [
        ...
        "Code review applied to test code",
        "Maintaining automation projects on GitHub",
      ],
    },
    {
    ...
    },
    {
      ...
      topics: [
        "Introduction to generative AI for testing",
        "Using AI to generate test scenarios",
        "AI-assisted test case generation",
        "Generating Selenium scripts with AI",
        "AI-assisted XPath and locator generation",
        "Converting manual test cases into automation scripts",
        "AI-assisted debugging",
        "Test data generation using AI",
        "Defect analysis and summarization",
        "Log analysis using AI",
        "Generating page objects with AI",
        "Refactoring automation code with AI",
        "AI-assisted framework development",
        "Prompt engineering for test engineers",
        "Using coding assistants in automation testing",
        "Best practices and limitations of AI-generated tests",
      ],
    },
  ],

  roadmapImage: {
    src: "/images/courses/selenium-java-path-v1.webp",
    width: 1400,
    height: 1064,
  ...
  syllabusDownload: {
    pdfUrl: "/downloads/selenium-java-syllabus-v1.pdf",
    title: "Selenium with Java Course Syllabus — Complete Module List",
    slug: "selenium-java-syllabus",
    blurb:
    ...
    asideBlocks: [
      ...
      },
      {
        ...
        items: [
          "QA Automation Engineer — the highest-volume automation role in Pune.",
          "Selenium Test Engineer — where services-sector demand concentrates.",
          "SDET — pairing this with API testing for the engineering-in-test role.",

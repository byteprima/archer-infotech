...
export const dataEngineeringTrainingInPune: CourseRichContent = {
  ...
  curriculum: [
    ...
    {
      title: "Linux, Python & the Data Engineer's Toolkit",
      weekRange: "Week 1",
      description:
        "Data engineering happens on Linux boxes, and the job assumes a command line you are comfortable in. Shell navigation, file and permission handling, process management, cron, ssh and log inspection — the operations you will use every day debugging a pipeline that failed at 3 a.m. Alongside it, the Python subset that matters for data work rather than for web development: file and API I/O, JSON and CSV handling, generators for data that does not fit in memory, error handling, logging, and writing a script that can be re-run safely after a partial failure.",
      topics: [
        "Shell navigation, permissions, processes",
        "cron, ssh and log inspection",
        "Python file, API and JSON handling",
        "Generators for out-of-memory data",
        "Virtual environments and dependency management",
        "Logging, retries and idempotent scripts",
    ...
    },
    {
      ...
      topics: [
          ...
          "Database, Schema, Table, Row, Column and Data Types",
    ...
    },
    {
      ...
      topics: [
          ...
          "Schema Validation",
          "Views, Tables and Incremental Models",
          "ETL vs ELT",
          "Type and Range Validation",
          "Ephemeral Models",
          "Database, API, File, Object Storage and SaaS Sources",
        ],
    },
    {
      title: "NoSQL, Data Modelling & Warehouse Design",
      weekRange: "Weeks 4–5",
      description:
        "Where data lives, and why the shape you choose constrains every query afterwards. Relational modelling and normalisation first, then the document, key-value, column-family and graph stores and the access patterns each is actually good at — MongoDB and Cassandra get used badly far more often than they get used well. Then dimensional modelling for analytics: facts and dimensions, star and snowflake schemas, slowly changing dimensions, surrogate keys, and grain — the single decision that determines whether a warehouse answers questions cleanly or fights you forever.",
      topics: [
        "Normalisation and relational modelling",
        "Document, key-value, column-family and graph stores",
        "MongoDB and Cassandra access patterns",
    ...
    },
    {
      ...
      topics: [
          ...
          "Reading CSV, JSON, Parquet, ORC and Database Data",
          "Execution Plans",
          "Distributed Storage",
    ...
    },
    {
      ...
      topics: [
          ...
          "Sources, Sinks, Transformations and Dependencies",
          "New, Updated and Deleted Records",
          "Insert, Update and Delete Capture",
          "DAG, Task, Operator, Scheduler and Executor",
          "Batch Pipelines",
    ...
    },
    {
      ...
      topics: [
          ...
          "Stateful Processing",
          "Producer Keys and Partition Selection",
    ...
    {
      title: "Data Quality, Observability & Governance",
      weekRange: "Week 10",
      description:
        "The difference between a pipeline that runs and a pipeline anyone trusts. You build quality checks into the pipeline rather than bolting them on: completeness, validity, uniqueness, freshness and referential integrity, with failures that stop bad data rather than propagate it. Then observability — freshness, volume, schema and distribution monitoring, and lineage so you can answer 'what breaks if I change this column?'. Governance closes it: cataloguing, ownership, access control, PII handling and the compliance obligations that come with holding customer data in India.",
      topics: [
        "Completeness, validity, uniqueness, freshness checks",
        "Great Expectations-style test suites",
        "Freshness, volume and schema monitoring",
        "Distribution drift detection",
        "Data lineage and impact analysis",
        "Cataloguing, ownership and stewardship",
        "PII handling, masking and access control",
        "Audit trails and compliance",
      ],
    },
    {
      title: "Cloud Data Platforms — Azure, AWS & GCP",
      weekRange: "Week 10",
      description:
        "The same pipeline patterns, expressed in the three clouds Pune employers actually run. Azure in most depth, because Azure Data Factory, Synapse and ADLS dominate the Pune services and GCC market: pipelines, linked services, integration runtimes and triggers. Then the AWS equivalents (Glue, S3, Redshift, EMR, Kinesis) and the GCP set (BigQuery, Dataflow, Pub/Sub, Composer) mapped concept for concept, so the skill transfers rather than being tied to one vendor. Cost and performance optimisation runs through it — partitioning, file sizing, caching and knowing what a query actually costs.",
      topics: [
        "Azure Data Factory, Synapse, ADLS Gen2",
        "AWS Glue, S3, Redshift, EMR, Kinesis",
        "GCP BigQuery, Dataflow, Pub/Sub, Composer",
        "Linked services, triggers and integration runtimes",
    ...
    },
    {
      ...
      topics: [
          ...
          "Advanced SQL",
          "Relational Database, API, Files and Event Streams",
          "Data Volume, Velocity and Variety",
          "Indexing, Partitioning and Transactions",
          "Batch, API, CDC and Kafka Ingestion",
  ...
  roadmapImage: {
    src: "/images/courses/data-engineering-workflow-v1.webp",
    width: 1400,
    height: 736,
    alt: "Diagram of the Data Engineering pipeline taught at Archer Infotech Pune: sources, ingestion with Kafka and CDC, storage in a data lake, warehouse or lakehouse, transformation with Spark, PySpark and dbt, orchestration with Airflow, and serving analytics and machine-learning consumers.",
    caption:
      "The six stages of the data pipeline this course builds — every stage is covered module by module below.",
  },


  syllabusDownload: {
    pdfUrl: "/downloads/data-engineering-syllabus-v1.pdf",
    title: "Data Engineering Course Syllabus — Complete Module List",
    slug: "data-engineering-syllabus",
    blurb:
      "The complete forty-nine-module syllabus as a 15-page PDF — Linux, Python and SQL foundations through data modelling, warehousing, ETL/ELT, Airflow, dbt, CDC, Spark, PySpark, Kafka, lakehouse architecture, cloud data platforms, governance and DataOps. Everything in it is on this page; the PDF is the portable version.",
    asideBlocks: [
      {
        heading: "What is inside the 15-page PDF",
        items: [
          "All forty-nine modules in teaching order, from data-engineering fundamentals to the capstone platform build.",
          "The full pipeline toolchain topic by topic — batch and streaming, orchestration with Airflow, transformations with dbt, Change Data Capture, and Spark performance tuning.",
          "Storage and modelling in depth: relational and NoSQL, dimensional modelling, warehousing, data lakes, lakehouse formats, file formats and compression.",
        ],
      },
      {
        heading: "Roles this syllabus prepares you for",
        items: [
          "Data Engineer — building and operating the pipelines analytics and ML depend on.",
          "Big Data Engineer — distributed processing with Spark and PySpark at volume.",
          "ETL Developer — ingestion and transformation across enterprise data estates.",
          "Data Platform Engineer — warehouse, lakehouse and cloud data infrastructure.",
        ],
      },
    ],
  },

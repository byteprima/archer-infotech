...
export const coursesSummary: CourseSummary[] = [
  ...
  },
  {
    ...
    category: "Testing & QA",
    categorySlug: "testing-qa",
    shortDescription: "Use GenAI for requirements, test design, test data, automation, debugging and QA documentation",
    duration: "1 Month",
    level: "Intermediate",
    mode: ["Online", "Offline"],
  ...
  },
  {
    ...
    category: "Testing & QA",
    categorySlug: "testing-qa",
    shortDescription: "Evaluate prompts, LLM responses, hallucinations, RAG quality, safety and AI regression",
    duration: "2 Months",
    level: "Advanced",
    mode: ["Online", "Offline"],
  ...
  },
  {
    ...
    category: "Testing & QA",
    categorySlug: "testing-qa",
    shortDescription: "Test AI agents, tool calls, workflows, memory, trajectories, safety and production quality",
    duration: "2 Months",
    level: "Advanced",
    mode: ["Online", "Offline"],

...
export const courses: Course[] = [
  ...
  },
  {
    ...
    shortDescription: "Build real applications with Cursor, Claude Code and Copilot — responsibly",
    duration: "2 Months",
    level: "Beginner",
    mode: ["Online", "Offline"],
    ...
    highlights: [
      ...
      "Prompting for code — requirements, structure, iteration",
      "Frontend, backend, database and API generation",
      "Reading and debugging AI-generated code",
      "Secure coding and code review for AI output",
      "Full capstone: a Patient & Chemist Management System",
      "Basic programming helpful but not mandatory",
    ],
    modules: [],
    faqs: [],
    prerequisites: [
      "Basic computer knowledge",
      "Programming knowledge is helpful but not mandatory",
    ],
    careerOpportunities: [
    ...
    targetAudience: [
      "Engineering, BCA, MCA and diploma students",
      "Fresh graduates and career starters",
      "Software developers and testers adding AI-assisted workflow",
      "Entrepreneurs and technical founders building a first product",
    ],
  },
  {
    id: "ai-tools",
  ...
  // ── P4-10 additions (2026-06-04): Testing & QA + Salesforce tracks ───────
  {
    ...
    level: "Intermediate",
    mode: ["Online", "Offline"],
    relatedSlugs: ["software-testing-training-in-pune", "selenium-python-training-in-pune", "playwright-training-in-pune", "ai-assisted-software-testing-training-in-pune"],
  ...
  },
  {
    ...
    level: "Beginner",
    mode: ["Online", "Offline"],
    relatedSlugs: ["selenium-training-in-pune", "selenium-python-training-in-pune", "api-testing-training-in-pune"],
  ...
  },
  {
    ...
    slug: "ai-assisted-software-testing-training-in-pune",
    seoTitle: "AI-Assisted Software Testing Course in Pune | AI for QA",
    heroHeading: "AI-Assisted Software Testing Training in Pune",
    title: "AI-Assisted Software Testing",
    shortTitle: "AI-Assisted Testing",
    category: "Testing & QA",
    categorySlug: "testing-qa",
    description:
    ...
    highlights: [
      "One month, aimed at testers who already test",
      "A reusable QA prompt library you keep afterwards",
      "Requirements, test design, test data, automation, triage, docs",
      "Reviewing AI output is taught as the core skill",
      "Responsible-use module — PII, secrets, proprietary code",
      "Tool-neutral: works with whichever assistant your employer allows",
    ],
    modules: [],
    faqs: [],
    prerequisites: [
      "Working software-testing knowledge — test cases, defects, an SDLC",
      "Coding is helpful but not mandatory for the manual-testing portions",
    ],
    careerOpportunities: [
    ...
    targetAudience: [
      "Manual testers wanting more output from the same hours",
      "Automation testers who want a deliberate AI workflow",
      "QA leads and test managers evaluating AI for their teams",
      "Business analysts who write acceptance criteria",
      "SDETs and experienced professionals",
    ],
  },
  {
    id: "llm-rag-testing",
    slug: "llm-rag-testing-training-in-pune",
    seoTitle: "LLM & RAG Testing Course in Pune | Generative AI Testing",
    heroHeading: "Generative AI, LLM & RAG Testing Training in Pune",
    title: "Generative AI, LLM & RAG Testing",
    shortTitle: "LLM & RAG Testing",
    category: "Testing & QA",
    categorySlug: "testing-qa",
    description:
    ...
    highlights: [
      "Evaluation replaces assertion — the core shift, taught properly",
      "Golden datasets, rubrics and regression baselines you build",
      "LLM-as-a-Judge, including where judges are wrong",
      "Full RAG evaluation — retrieval, grounding, citations, isolation",
      "Prompt injection, PII leakage and safety regression suites",
      "Tool-neutral: DeepEval, RAGAS, Promptfoo and LangSmith as examples",
    ],
    modules: [],
    faqs: [],
    prerequisites: [
      "Software-testing fundamentals",
      "Basic Python — writing functions and running pytest",
      "API-testing fundamentals (REST, JSON, authentication)",
    ],
    careerOpportunities: [
      "GenAI Test Engineer",
      "LLM QA Engineer",
    ...
    targetAudience: [
      ...
      "Senior manual testers with automation exposure",
      "QA leads whose teams have started shipping AI features",
      "Developers and AI engineers who need evaluation knowledge",
    ],
  },
  {
    id: "agentic-ai-testing",
    slug: "agentic-ai-testing-training-in-pune",
    seoTitle: "Agentic AI Testing Course in Pune | AI Quality Engineering",
    heroHeading: "Agentic AI Testing & AI Quality Engineering Training in Pune",
    title: "Agentic AI Testing & AI Quality Engineering",
    shortTitle: "Agentic AI Testing",
    category: "Testing & QA",
    categorySlug: "testing-qa",
    description:
    ...
    highlights: [
      "Trajectory evaluation — judging the path, not only the answer",
      "Tool-call testing: wrong tool, bad arguments, tool failures, retries",
      "Memory testing including cross-user leakage",
      "Indirect prompt injection and excessive agency",
      "Golden-task harness with mocked tools, run in CI",
      "Production quality engineering — tracing, drift, review queues",
    ],
    modules: [],
    faqs: [],
    prerequisites: [
      "Automation testing and API testing experience",
      "Basic Python and pytest",
      "LLM testing fundamentals — the LLM & RAG Testing course, or equivalent",
    ],
    careerOpportunities: [
    ...
    targetAudience: [
      "Senior QA and automation engineers",
      "SDETs and AI/LLM testers",
      "QA leads owning AI release gates",
      "AI developers moving into evaluation",
    ],
  },
  {
    id: "salesforce",

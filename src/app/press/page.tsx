...
const fastFacts: { label: string; value: string }[] = [
  ...
  { label: "Campuses", value: "Kothrud, Pune and Vishrambag, Sangli, Maharashtra, India" },
...
const boilerplate = {
  short:
    `Archer Infotech is an IT training institute with campuses in Kothrud, Pune and Vishrambag, Sangli. Founded in ${siteConfig.foundingYear}, it has trained ${siteConfig.stats.studentsTrained} students and placed ${siteConfig.stats.studentsPlaced} at IT companies.`,
  medium:
    `Founded in ${siteConfig.foundingYear}, Archer Infotech is an IT training institute with campuses in Kothrud, Pune and Vishrambag, Sangli. It has trained ${siteConfig.stats.studentsTrained} students and placed ${siteConfig.stats.studentsPlaced} professionals at companies across the IT industry. It offers ${siteConfig.stats.courses} courses spanning Java, Python, full-stack development, data science, AI/ML, cloud and DevOps in classroom, live online and weekend formats, backed by placement assistance and trainers with MNC experience.`,
  long:

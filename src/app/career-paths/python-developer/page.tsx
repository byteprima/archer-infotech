    ...
    <>
      ...
      <article aria-labelledby="pillar-title">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 space-y-14 max-w-4xl">
          ...
          {/* P5-17 — newsletter banner between FAQ and CTA. Lower-commitment
              ask (free monthly briefing) before the higher-commitment one
              (book a demo). */}
          <NewsletterSignupForm
            placement="career-path-python-developer"
            variant="banner"
            headline="Pune Python careers — monthly briefing"
      ...
      <SourceCitations
        ...
        items={sourcesForTopics(["python", "django", "data-science"])}
      />
    </>
  );
}

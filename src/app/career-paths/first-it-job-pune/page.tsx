  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 space-y-14 max-w-4xl">
          ...
          >
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <li>
                <Link
                  href="/guides/year-one-mistakes-pune-it-freshers-make-2026"
                  className="block rounded border p-3 bg-card hover:border-secondary transition-colors"
                >
                  <span className="font-medium block text-sm">
                    10 Year-One Mistakes Pune IT Freshers Make
                  </span>
                  <span className="text-xs text-muted-foreground">
                    Guide · post-joining career velocity patterns
                  </span>
                </Link>
              </li>
              <li>
          ...
          <NewsletterSignupForm
            placement="career-path-first-it-job-pune"
            variant="banner"
            headline="Pune fresher IT careers — monthly briefing"
      ...
      <SourceCitations
        ...
        items={sourcesForTopics(["java", "python", "javascript"])}
      />
    </>
  );
}

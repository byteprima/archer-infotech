  ...
  return (
    <>
      ...
      <article aria-labelledby="pillar-title">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 space-y-14 max-w-4xl">
          ...
          >
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <li>
                ...
                >
                  <span className="font-medium block text-sm">
                    10 Java Streams API Patterns for Pune Developers
                  </span>
                  <span className="text-xs text-muted-foreground">
                    Guide · filter + map + collect + flatMap + Optional
                  </span>
                </Link>
              </li>
              <li>
          ...
          <NewsletterSignupForm
            placement="career-path-java-developer"
            variant="banner"
            headline="Pune Java careers — monthly briefing"
      ...
      <SourceCitations
        ...
        items={sourcesForTopics(["java-full-stack", "spring-boot", "java"])}
      />
    </>
  );
}

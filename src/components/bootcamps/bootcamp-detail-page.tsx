 ...
 * after first paint. SSR stays on (default) so HTML is still in the
 * initial document for SEO + AI crawlers. */
const TrackTabs = nextDynamic(
  () =>
    import("./bootcamp-interactive-sections").then((m) => ({
      default: m.TrackTabs,
    })),
);
const FoundationCurriculum = nextDynamic(
  () =>
    import("./bootcamp-interactive-sections").then((m) => ({
      default: m.FoundationCurriculum,
    })),
);
const ProgramTabs = nextDynamic(
  () =>
    import("./bootcamp-interactive-sections").then((m) => ({
      default: m.ProgramTabs,
    })),
);

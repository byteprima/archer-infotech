...
import { deleteSeminar } from "@/lib/actions/seminars";

/** Two-step delete — see delete-drive-button for the reasoning. */
export function DeleteSeminarButton({ id, label }: { id: number; label: string }) {
